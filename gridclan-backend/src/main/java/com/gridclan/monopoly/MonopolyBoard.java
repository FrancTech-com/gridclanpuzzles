...
/**
 * The standard 40-square Monopoly board — pure data.
 *
 * Square types: GO, PROP (streets), RAIL, UTIL, TAX, CHANCE, CHEST,
 * JAIL (just visiting), GO_TO_JAIL, FREE (free parking).
 * Street rents: {base, 1 house, 2, 3, 4, hotel}. Base rent doubles with a
...
public final class MonopolyBoard {
    ...
    public static final List<Square> SQUARES = List.of(
        plain(0, "GO", "GO"),
        prop(1,  "Mediterranean Avenue", "BROWN",  60,  50,  2, 10, 30, 90, 160, 250),
        plain(2, "CHEST", "Community Chest"),
        prop(3,  "Baltic Avenue",        "BROWN",  60,  50,  4, 20, 60, 180, 320, 450),
        tax(4,   "Income Tax", 200),
        rail(5,  "Reading Railroad"),
        prop(6,  "Oriental Avenue",      "LIGHT_BLUE", 100, 50, 6, 30, 90, 270, 400, 550),
        plain(7, "CHANCE", "Chance"),
        prop(8,  "Vermont Avenue",       "LIGHT_BLUE", 100, 50, 6, 30, 90, 270, 400, 550),
        prop(9,  "Connecticut Avenue",   "LIGHT_BLUE", 120, 50, 8, 40, 100, 300, 450, 600),
        plain(10, "JAIL", "Jail / Just Visiting"),
        prop(11, "St. Charles Place",    "PINK",   140, 100, 10, 50, 150, 450, 625, 750),
        util(12, "Electric Company"),
        prop(13, "States Avenue",        "PINK",   140, 100, 10, 50, 150, 450, 625, 750),
        prop(14, "Virginia Avenue",      "PINK",   160, 100, 12, 60, 180, 500, 700, 900),
        rail(15, "Pennsylvania Railroad"),
        prop(16, "St. James Place",      "ORANGE", 180, 100, 14, 70, 200, 550, 750, 950),
        plain(17, "CHEST", "Community Chest"),
        prop(18, "Tennessee Avenue",     "ORANGE", 180, 100, 14, 70, 200, 550, 750, 950),
        prop(19, "New York Avenue",      "ORANGE", 200, 100, 16, 80, 220, 600, 800, 1000),
        plain(20, "FREE", "Free Parking"),
        prop(21, "Kentucky Avenue",      "RED",    220, 150, 18, 90, 250, 700, 875, 1050),
        plain(22, "CHANCE", "Chance"),
        prop(23, "Indiana Avenue",       "RED",    220, 150, 18, 90, 250, 700, 875, 1050),
        prop(24, "Illinois Avenue",      "RED",    240, 150, 20, 100, 300, 750, 925, 1100),
        rail(25, "B. & O. Railroad"),
        prop(26, "Atlantic Avenue",      "YELLOW", 260, 150, 22, 110, 330, 800, 975, 1150),
        prop(27, "Ventnor Avenue",       "YELLOW", 260, 150, 22, 110, 330, 800, 975, 1150),
        util(28, "Water Works"),
        prop(29, "Marvin Gardens",       "YELLOW", 280, 150, 24, 120, 360, 850, 1025, 1200),
        plain(30, "GO_TO_JAIL", "Go To Jail"),
        prop(31, "Pacific Avenue",       "GREEN",  300, 200, 26, 130, 390, 900, 1100, 1275),
        prop(32, "North Carolina Avenue","GREEN",  300, 200, 26, 130, 390, 900, 1100, 1275),
        plain(33, "CHEST", "Community Chest"),
        prop(34, "Pennsylvania Avenue",  "GREEN",  320, 200, 28, 150, 450, 1000, 1200, 1400),
        rail(35, "Short Line"),
        plain(36, "CHANCE", "Chance"),
        prop(37, "Park Place",           "DARK_BLUE", 350, 200, 35, 175, 500, 1100, 1300, 1500),
        tax(38,  "Luxury Tax", 100),
        prop(39, "Boardwalk",            "DARK_BLUE", 400, 200, 50, 200, 600, 1400, 1700, 2000)
    );
